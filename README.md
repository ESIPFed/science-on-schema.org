...
- Arctic Data Center ([url](https://arcticdata.io/))
- Arctic Data Collaborative (ARDAC)
- Arctic Spatial Data Infrastructure (ASDI) ([url](https://arctic-sdi.org/))
- ArcticConnect ([url](http://arcticconnect.ca/))
- ARM - Atmospheric Radiation Measurement Research Facility ([url](https://arm.gov/data/))
- Biological and Chemical Oceanography Data Management Office (BCO-DMO) ([url](http://www.bco-dmo.org/), [sitemap](https://www.bco-dmo.org/sitemap.xml))
- BonaRes
- Borealis ([url](https://borealisdata.ca/), [sitemap](https://borealisdata.ca/sitemap.xml))
- British Antarctic Survey ([url](https://www.bas.ac.uk/), [sitemap](https://www.bas.ac.uk/sitemap.xml))
- California Ocean Protection Council Data Repository ([url](https://opc.dataone.org/))
- CanWIN ([url](https://umanitoba.ca/canwin), [sitemap](https://canwin-datahub.ad.umanitoba.ca/data/sitemap.xml))
- Cary Institute of Ecosystem Studies (powered by Figshare) ([url](https://www.caryinstitute.org/))
- CCADI ([url](https://ccadi.org/))
- CCHDO ([url](https://cchdo.ucsd.edu/), [sitemap](https://cchdo.ucsd.edu/sitemap.xml))
- CERP - South Florida Water Management District ([url](https://cerp-sfwmd.dataone.org/))
- Chinese Ecosystem Research Network (CERN) ([url](http://www.cern.ac.cn))
- CIOOS ([url](https://catalogue.cioos.ca/), [sitemap](https://catalogue.ogsl.ca/sitemap/sitemap-1.xml))
- DataverseNL ([url](https://dataverse.nl/), [sitemap](https://dataverse.nl/sitemap.xml))
- DataverseNO ([url](https://dataverse.no/), [sitemap](https://dataverse.no/sitemap/sitemap.xml))
- Defense Resiliency Platform Against Extreme Cold Weather ([url](https://drp.dataone.org/))
- Dryad ([url](https://datadryad.org), [sitemap](https://datadryad.org/sitemap.xml))
- Earth Data Analysis Center (EDAC) ([url](http://edac.unm.edu/))
- EarthChem ([url](https://www.earthchem.org/ecl), [sitemap](https://ecl.earthchem.org/sitemap.xml))
- EcoBank ([url](https://nie-ecobank.kr/), [sitemap](https://nie-ecobank.kr/sitemap.xml))
- Environmental Data Initiative ([url](https://edirepository.org/))
- ESA Data Registry ([url](http://www.esa.org))
- ESS-DIVE ([url](https://ess-dive.lbl.gov))
- Europe Long-Term Ecosystem Research Network (LTER Europe) ([url](http://www.lter-europe.net/))
- Forest Ecosystem Monitoring Cooperative ([url](https://www.uvm.edu/femc))
- GEM -- Greenland Ecosystem Monitoring ([url](https://g-e-m.dk/), [sitemap](https://data.g-e-m.dk/sitemap))
- GeoSensorWebLab
- GRIL: metaGRIL ([url](https://oraprdnt.uqtr.uquebec.ca/pls/public/gscw030?owa_no_site=543))
- Gulf of Alaska Data Portal ([url](http://portal.aoos.org/gulf-of-alaska.php))
- Gulf of Mexico Research Initiative ([url](https://www.griidc.org/))
- Gulf of Mexico Research Initiative (GRIIDC) ([url](https://www.griidc.org/), [sitemap](https://data.griidc.org/sitemap.xml))
- Harvard Dataverse ([url](https://dataverse.harvard.edu/), [sitemap](https://dataverse.harvard.edu/sitemap/sitemap.xml))
- HydroShare ([url](https://www.hydroshare.org/), [sitemap](https://www.hydroshare.org/sitemap.xml))
- ICRISAT
- IEDA: Marine-Geo Digital Library ([url](http://www.marine-geo.org/library/))
- International Year of the Salmon Catalogue ([url](https://iys.hakai.org/), [sitemap](https://iys.hakai.org/sitemap/sitemap.xml))
- IRIS ([url](https://www.iris.edu/hq/))
- ISRIC - World Soil Information ([url](https://data.isric.org/), [sitemap](https://data.isric.org/geonetwork/srv/api/sitemap))
- Knowledge Network for Biocomplexity ([url](https://knb.ecoinformatics.org/))
- Linked Earth ([url](https://wiki.linked.earth/Main_Page))
- LTER Network ([url](http://www.lternet.edu/))
- MagIC ([url](https://www2.earthref.org/MagIC), [sitemap](https://earthref.org/MagIC/contributions.sitemap.xml))
- Merritt Repository ([url](https://merritt.cdlib.org/))
- Minnesota Population Center (MPC) ([url](https://www.pop.umn.edu/index.php))
- Montana IoE Data Repository ([url](http://montanaioe.org/))
- National Ecological Observatory Network ([url](http://www.neoninc.org/))
- National Snow and Ice Data Center (NSIDC) ([url](https://nsidc.org), [sitemap](https://nsidc.org/sitemap.xml))
- Neotoma ([url](https://www.neotomadb.org/))
- Netherlands Polar Data Center (NPDC) ([url](https://npdc.nl/), [sitemap](https://npdc.nl/sitemap.xml))
- Nevada Research Data Center ([url](http://www.sensor.nevada.edu/))
- NM EPSCoR ([url](http://www.nmepscor.org))
- NOAA NCEI Environmental Data Archive ([url](https://www.ncei.noaa.gov))
- Nordicana D ([url](https://nordicana.cen.ulaval.ca/), [sitemap](https://nordicana.cen.ulaval.ca/sitemap.xml))
- OBIS-SEAMAP ([url](https://seamap.env.duke.edu/))
- Open Data (Canada)
- OpenTopography ([url](https://opentopography.org), [sitemap](https://portal.opentopography.org/sitemap.xml))
- Pangaea ([url](https://pangaea.de/), [sitemap](https://doi.pangaea.de/sitemap.xml))
- PISCO MN ([url](http://www.piscoweb.org/))
- PNDB Data Repository ([url](https://www.pndb.fr/))
- Polar Data Catalog (PDC) ([url](https://www.polardata.ca/))
- Programa de Pesquisa em Biodiversidade (PPBio) ([url](https://ppbio.inpa.gov.br/en/repository))
- Research Data Archive (RDA) ([url](https://rda.ucar.edu/))
- Research Workspace ([url](https://researchworkspace.com))
- Rolling Deck to Repository (R2R) ([url](http://www.rvdata.us/))
- SANParks Data Repository ([url](http://sanparks.org.za/))
- SEAD Virtual Archive ([url](http://sead-data.net/))
- Smithsonian Research Data Repository ([url](https://smithsonian.dataone.org))
- SNAP ([url](https://catalog.snap.uaf.edu/))
- South Florida Water Management District (SFWMD) ([url](https://www.sfwmd.gov/))
- Stony Coral Tissue Loss Disease (SCTLD) Research Data Portal ([url](https://floridadep.gov/rcp/coral/content/stony-coral-tissue-loss-disease-response))
- Taiwan Forestry Research Institute ([url](https://www.tfri.gov.tw/))
- TERN Australia ([url](http://www.tern.org.au/))
- the Digital Archaeological Record ([url](https://www.tdar.org/))
- UNAVCO ([url](https://www.unavco.org/data/data.html))
- UNC Dataverse
- University of Idaho Research Computing and Data Services ([url](https://data.nkn.uidaho.edu/))
- US Antarctic Program Data Center ([url](https://www.usap-dc.org/), [sitemap](https://www.usap-dc.org/view/dataset/sitemap.xml))
- USGS Science Data Catalog ([url](http://data.usgs.gov/datacatalog/))
- Wildland Fire Science Initiative (WFSI) Data Portal ([url](https://portal.wfsi-data.org/))
